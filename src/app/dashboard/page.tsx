    ...
    <main className="flex flex-col justify-center text-center max-w-5xl mx-auto my-12">
      ...
      <Table>
        ...
        <TableBody>
          ...
          <TableRow>
            <TableCell className="font-medium text-left p-4">
              <span className="font-semibold">11/31/2024</span>
            </TableCell>
            <TableCell className="text-left p-4">
              <span className="font-semibold">Phillip S. Hoffman</span>
            </TableCell>
            <TableCell className="text-left p-4">phil@hoffman.com</TableCell>
            <TableCell className="text-center p-4">
              <Badge className="rounded-full">Open</Badge>
            </TableCell>
            <TableCell className="text-right p-4">
